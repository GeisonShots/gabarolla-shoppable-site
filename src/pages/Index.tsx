  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative w-full h-[70vh] md:h-[85vh] overflow-hidden">
        <img src={heroImg} alt="Gabarolla Hero" className="w-full h-full object-cover object-top" />
        ...
        >
          <a
            href="#produtos"
            className="inline-block bg-primary text-primary-foreground font-display text-lg px-10 py-4 hover:bg-primary/90 transition-colors tracking-wider"
          >
            Ver Colecção
          </a>
        </motion.div>
